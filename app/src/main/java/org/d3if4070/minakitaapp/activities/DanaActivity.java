...
import org.d3if4070.minakitaapp.fragments.CrowdfundingFragment;
...
public class DanaActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    TextView popupTitle,popupDescription, popupDana;
    ...
    private void iniPopup() {
        ...
        popupDana = popAddPost.findViewById(R.id.popup_dana);
        ...
        popupAddBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (!popupTitle.getText().toString().isEmpty()
                        ...
                        && !popupDana.getText().toString().isEmpty()
                        && pickedImgUri != null ) {
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        } else if (id == R.id.nav_dana) {

            getSupportActionBar().setTitle("Pendanaan");
            getSupportFragmentManager().beginTransaction().replace(R.id.container,new CrowdfundingFragment()).commit();
